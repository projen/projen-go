...
type AwsCdkDepsOptions struct {
	...
	// Experimental.
	DependencyType projen.DependencyType `json:"dependencyType" yaml:"dependencyType"`
}
...
type AwsCdkJavaAppOptions struct {
	...
	// Compile options.
	// Experimental.
	CompileOptions *java.MavenCompileOptions `json:"compileOptions" yaml:"compileOptions"`
	...
	// junit options.
	// Experimental.
	JunitOptions *java.JunitOptions `json:"junitOptions" yaml:"junitOptions"`
	// Packaging options.
	// Experimental.
	PackagingOptions *java.MavenPackagingOptions `json:"packagingOptions" yaml:"packagingOptions"`
	...
	// Experimental.
	ProjenrcJavaOptions *java.ProjenrcOptions `json:"projenrcJavaOptions" yaml:"projenrcJavaOptions"`
...
type AwsCdkPackageNames struct {
	...
	// Experimental.
	Constructs *string `json:"constructs" yaml:"constructs"`
	// Fully qualified name of the core framework package for CDKv1.
	// Experimental.
	CoreV1 *string `json:"coreV1" yaml:"coreV1"`
	// Fully qualified name of the core framework package for CDKv2.
	// Experimental.
	CoreV2 *string `json:"coreV2" yaml:"coreV2"`
...
type LambdaFunctionCommonOptions struct {
	...
	// Experimental.
	Runtime LambdaRuntime `json:"runtime" yaml:"runtime"`
}
