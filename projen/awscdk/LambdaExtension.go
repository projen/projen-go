...
func (l *jsiiProxy_LambdaExtension) PostProjectCreation(initProject *projen.InitProject) {
...
func (l *jsiiProxy_LambdaExtension) ProjectCreation(initProject *projen.InitProject) {
...
func (l *jsiiProxy_LambdaExtension) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
