...
func (j *jsiiProxy_AwsCdkTypeScriptApp) Runner() typescript.TypeScriptRunner {
...
func (a *jsiiProxy_AwsCdkTypeScriptApp) DefaultTypeScriptCompilerOptions() *javascript.TypeScriptCompilerOptions {
...
func (a *jsiiProxy_AwsCdkTypeScriptApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
