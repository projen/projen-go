...
func (j *jsiiProxy_ConstructLibraryAws) Subprojects() *[]projen.Project {
	var returns *[]projen.Project
	_jsii_.Get(
		j,
		"subprojects",
...
func (c *jsiiProxy_ConstructLibraryAws) AddPackageIgnore(_pattern *string) {
...
func (c *jsiiProxy_ConstructLibraryAws) AnnotateGenerated(_glob *string) {
...
func (c *jsiiProxy_ConstructLibraryAws) DefaultTypeScriptCompilerOptions() *javascript.TypeScriptCompilerOptions {
...
func (c *jsiiProxy_ConstructLibraryAws) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
