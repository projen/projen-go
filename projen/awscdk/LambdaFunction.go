...
func (l *jsiiProxy_LambdaFunction) PostProjectCreation(initProject *projen.InitProject) {
...
func (l *jsiiProxy_LambdaFunction) ProjectCreation(initProject *projen.InitProject) {
