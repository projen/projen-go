...
func (a *jsiiProxy_AwsCdkDepsPy) PostProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AwsCdkDepsPy) ProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AwsCdkDepsPy) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
