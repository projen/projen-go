...
func (j *jsiiProxy_AwsCdkConstructLibrary) Biome() javascript.Biome {
...
func (j *jsiiProxy_AwsCdkConstructLibrary) Node() constructs.Node {
...
func (j *jsiiProxy_AwsCdkConstructLibrary) NodeVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nodeVersion",
...
func (j *jsiiProxy_AwsCdkConstructLibrary) Runner() typescript.TypeScriptRunner {
...
func NewAwsCdkConstructLibrary(options *AwsCdkConstructLibraryOptions) AwsCdkConstructLibrary {
	...
	if err := validateNewAwsCdkConstructLibraryParameters(options); err != nil {
		panic(err)
	}
...
// Experimental.
func AwsCdkConstructLibrary_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAwsCdkConstructLibrary_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AwsCdkConstructLibrary_IsProject(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAwsCdkConstructLibrary_IsProjectParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AwsCdkConstructLibrary_Of(construct constructs.IConstruct) projen.Project {
	_init_.Initialize()

	if err := validateAwsCdkConstructLibrary_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns projen.Project
...
func AwsCdkConstructLibrary_DEFAULT_TS_JEST_TRANFORM_PATTERN() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"projen.awscdk.AwsCdkConstructLibrary",
...
func (a *jsiiProxy_AwsCdkConstructLibrary) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_AwsCdkConstructLibrary) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
