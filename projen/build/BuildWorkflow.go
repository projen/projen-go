...
func (b *jsiiProxy_BuildWorkflow) PostProjectCreation(initProject *projen.InitProject) {
...
func (b *jsiiProxy_BuildWorkflow) ProjectCreation(initProject *projen.InitProject) {
...
func (b *jsiiProxy_BuildWorkflow) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
