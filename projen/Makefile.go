...
func (j *jsiiProxy_Makefile) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (m *jsiiProxy_Makefile) PostProjectCreation(initProject *InitProject) {
...
func (m *jsiiProxy_Makefile) ProjectCreation(initProject *InitProject) {
...
func (m *jsiiProxy_Makefile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
