...
func (j *jsiiProxy_ConstructLibraryCdktf) Biome() javascript.Biome {
...
func (c *jsiiProxy_ConstructLibraryCdktf) DefaultTypeScriptCompilerOptions() *javascript.TypeScriptCompilerOptions {
