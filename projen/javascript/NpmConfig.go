...
func (n *jsiiProxy_NpmConfig) PostProjectCreation(initProject *projen.InitProject) {
...
func (n *jsiiProxy_NpmConfig) ProjectCreation(initProject *projen.InitProject) {
...
func (n *jsiiProxy_NpmConfig) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
