...
func (p *jsiiProxy_Prettier) PostProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_Prettier) ProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_Prettier) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
