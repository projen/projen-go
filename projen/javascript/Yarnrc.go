...
func (y *jsiiProxy_Yarnrc) PostProjectCreation(initProject *projen.InitProject) {
...
func (y *jsiiProxy_Yarnrc) ProjectCreation(initProject *projen.InitProject) {
...
func (y *jsiiProxy_Yarnrc) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
