...
func (j *jsiiProxy_NodeProject) Node() constructs.Node {
...
func (j *jsiiProxy_NodeProject) WorkflowBootstrapSteps() *[]*workflows.JobStep {
...
func NewNodeProject(options *NodeProjectOptions) NodeProject {
	...
	if err := validateNewNodeProjectParameters(options); err != nil {
		panic(err)
	}
...
func NodeProject_IsConstruct(x interface{}) *bool {
	...
	if err := validateNodeProject_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func NodeProject_IsProject(x interface{}) *bool {
	...
	if err := validateNodeProject_IsProjectParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func NodeProject_Of(construct constructs.IConstruct) projen.Project {
	...
	if err := validateNodeProject_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns projen.Project
...
func (n *jsiiProxy_NodeProject) AddScripts(scripts *map[string]*string) {
...
func (n *jsiiProxy_NodeProject) ToString() *string {
	var returns *string
...
func (n *jsiiProxy_NodeProject) TryRemoveFile(filePath *string) projen.FileBase {
