...
func (s *jsiiProxy_SampleDir) PostProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SampleDir) ProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SampleDir) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
