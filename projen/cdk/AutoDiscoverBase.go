...
func (j *jsiiProxy_AutoDiscoverBase) Node() constructs.Node {
...
// Experimental.
func AutoDiscoverBase_IsComponent(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutoDiscoverBase_IsComponentParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func AutoDiscoverBase_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateAutoDiscoverBase_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (a *jsiiProxy_AutoDiscoverBase) PostProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AutoDiscoverBase) ProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AutoDiscoverBase) ToString() *string {
	var returns *string
...
func (a *jsiiProxy_AutoDiscoverBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
