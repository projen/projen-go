...
func (j *jsiiProxy_ConstructLibrary) Biome() javascript.Biome {
...
func (j *jsiiProxy_ConstructLibrary) Node() constructs.Node {
...
func (j *jsiiProxy_ConstructLibrary) NodeVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nodeVersion",
...
func (j *jsiiProxy_ConstructLibrary) Npmrc() javascript.NpmConfig {
...
func (j *jsiiProxy_ConstructLibrary) WorkflowBootstrapSteps() *[]*workflows.JobStep {
...
func (j *jsiiProxy_ConstructLibrary) WorkflowPackageCache() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
// Experimental.
func ConstructLibrary_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConstructLibrary_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConstructLibrary_IsProject(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConstructLibrary_IsProjectParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConstructLibrary_Of(construct constructs.IConstruct) projen.Project {
	_init_.Initialize()

	if err := validateConstructLibrary_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns projen.Project
...
func (c *jsiiProxy_ConstructLibrary) AddPackageIgnore(_pattern *string) {
...
func (c *jsiiProxy_ConstructLibrary) AddScripts(scripts *map[string]*string) {
...
func (c *jsiiProxy_ConstructLibrary) DefaultTypeScriptCompilerOptions() *javascript.TypeScriptCompilerOptions {
...
func (c *jsiiProxy_ConstructLibrary) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_ConstructLibrary) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
