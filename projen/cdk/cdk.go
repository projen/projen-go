...
type Catalog struct {
	...
	// Experimental.
	Announce *bool `json:"announce" yaml:"announce"`
...
type ConstructLibraryOptions struct {
	...
	// Experimental.
	PublishToGo *JsiiGoTarget `json:"publishToGo" yaml:"publishToGo"`
	// Publish to maven.
	// Experimental.
	PublishToMaven *JsiiJavaTarget `json:"publishToMaven" yaml:"publishToMaven"`
	// Publish to NuGet.
	// Experimental.
	PublishToNuget *JsiiDotNetTarget `json:"publishToNuget" yaml:"publishToNuget"`
	// Publish to pypi.
	// Experimental.
...
type JsiiDotNetTarget struct {
	...
	// Experimental.
	DotNetNamespace *string `json:"dotNetNamespace" yaml:"dotNetNamespace"`
	// Experimental.
...
type JsiiJavaTarget struct {
	...
	// Experimental.
	JavaPackage *string `json:"javaPackage" yaml:"javaPackage"`
	// Experimental.
	MavenArtifactId *string `json:"mavenArtifactId" yaml:"mavenArtifactId"`
	// Experimental.
	MavenGroupId *string `json:"mavenGroupId" yaml:"mavenGroupId"`
}
...
type JsiiPythonTarget struct {
	...
	// Experimental.
	DistName *string `json:"distName" yaml:"distName"`
	// Experimental.
