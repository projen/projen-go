...
func (j *jsiiProxy_JsiiDocgen) PostProjectCreation(initProject *projen.InitProject) {
...
func (j *jsiiProxy_JsiiDocgen) ProjectCreation(initProject *projen.InitProject) {
...
func (j *jsiiProxy_JsiiDocgen) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
