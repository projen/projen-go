...
func (p *jsiiProxy_ProjenrcFile) validatePostProjectCreationParameters(initProject *InitProject) error {
	return nil
}

func (p *jsiiProxy_ProjenrcFile) validateProjectCreationParameters(initProject *InitProject) error {
	return nil
}
