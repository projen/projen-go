...
func (p *jsiiProxy_ProjenrcJson) validatePostProjectCreationParameters(initProject *InitProject) error {
	if initProject == nil {
...
func (p *jsiiProxy_ProjenrcJson) validateProjectCreationParameters(initProject *InitProject) error {
	if initProject == nil {
		return fmt.Errorf("parameter initProject is required, but nil was provided")
	}
	if err := _jsii_.ValidateStruct(initProject, func() string { return "parameter initProject" }); err != nil {
