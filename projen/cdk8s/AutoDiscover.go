...
func (a *jsiiProxy_AutoDiscover) PostProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AutoDiscover) ProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AutoDiscover) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
