...
func (j *jsiiProxy_Cdk8sTypeScriptApp) Biome() javascript.Biome {
...
func (c *jsiiProxy_Cdk8sTypeScriptApp) AddPackageIgnore(_pattern *string) {
...
func (c *jsiiProxy_Cdk8sTypeScriptApp) AnnotateGenerated(_glob *string) {
...
func (c *jsiiProxy_Cdk8sTypeScriptApp) DefaultTypeScriptCompilerOptions() *javascript.TypeScriptCompilerOptions {
...
func (c *jsiiProxy_Cdk8sTypeScriptApp) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
