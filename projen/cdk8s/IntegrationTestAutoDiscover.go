...
func (i *jsiiProxy_IntegrationTestAutoDiscover) PostProjectCreation(initProject *projen.InitProject) {
...
func (i *jsiiProxy_IntegrationTestAutoDiscover) ProjectCreation(initProject *projen.InitProject) {
...
func (i *jsiiProxy_IntegrationTestAutoDiscover) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
