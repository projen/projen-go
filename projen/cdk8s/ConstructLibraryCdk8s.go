...
func (j *jsiiProxy_ConstructLibraryCdk8s) Node() constructs.Node {
...
func (j *jsiiProxy_ConstructLibraryCdk8s) Npmrc() javascript.NpmConfig {
...
func (j *jsiiProxy_ConstructLibraryCdk8s) Runner() typescript.TypeScriptRunner {
...
func (j *jsiiProxy_ConstructLibraryCdk8s) WorkflowBootstrapSteps() *[]*workflows.JobStep {
...
func (j *jsiiProxy_ConstructLibraryCdk8s) WorkflowPackageCache() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func NewConstructLibraryCdk8s(options *ConstructLibraryCdk8sOptions) ConstructLibraryCdk8s {
	...
	if err := validateNewConstructLibraryCdk8sParameters(options); err != nil {
		panic(err)
	}
...
// Experimental.
func ConstructLibraryCdk8s_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConstructLibraryCdk8s_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConstructLibraryCdk8s_IsProject(x interface{}) *bool {
	_init_.Initialize()

	if err := validateConstructLibraryCdk8s_IsProjectParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ConstructLibraryCdk8s_Of(construct constructs.IConstruct) projen.Project {
	_init_.Initialize()

	if err := validateConstructLibraryCdk8s_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns projen.Project
...
func (c *jsiiProxy_ConstructLibraryCdk8s) ToString() *string {
	var returns *string
...
func (c *jsiiProxy_ConstructLibraryCdk8s) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
