...
func (j *jsiiProxy_YamlFile) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (y *jsiiProxy_YamlFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (y *jsiiProxy_YamlFile) PostProjectCreation(initProject *InitProject) {
	if err := y.validatePostProjectCreationParameters(initProject); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		y,
...
func (y *jsiiProxy_YamlFile) ProjectCreation(initProject *InitProject) {
	if err := y.validateProjectCreationParameters(initProject); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		y,
...
func (y *jsiiProxy_YamlFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
