...
func (p *jsiiProxy_PullRequestLint) PostProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PullRequestLint) ProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PullRequestLint) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
