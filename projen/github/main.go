...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "appendStep", GoMethod: "AppendStep"},
			...
			_jsii_.MemberMethod{JsiiMethod: "getStep", GoMethod: "GetStep"},
			_jsii_.MemberMethod{JsiiMethod: "insertStepAfter", GoMethod: "InsertStepAfter"},
			_jsii_.MemberMethod{JsiiMethod: "insertStepBefore", GoMethod: "InsertStepBefore"},
			_jsii_.MemberProperty{JsiiProperty: "jobs", GoGetter: "Jobs"},
			_jsii_.MemberProperty{JsiiProperty: "name", GoGetter: "Name"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
			_jsii_.MemberMethod{JsiiMethod: "on", GoMethod: "On"},
			_jsii_.MemberMethod{JsiiMethod: "patchStep", GoMethod: "PatchStep"},
			_jsii_.MemberMethod{JsiiMethod: "postSynthesize", GoMethod: "PostSynthesize"},
			_jsii_.MemberMethod{JsiiMethod: "preSynthesize", GoMethod: "PreSynthesize"},
			_jsii_.MemberProperty{JsiiProperty: "project", GoGetter: "Project"},
			_jsii_.MemberProperty{JsiiProperty: "projenCredentials", GoGetter: "ProjenCredentials"},
			...
			_jsii_.MemberMethod{JsiiMethod: "replaceStep", GoMethod: "ReplaceStep"},
