...
func (t *jsiiProxy_TaskWorkflow) PostProjectCreation(initProject *projen.InitProject) {
...
func (t *jsiiProxy_TaskWorkflow) ProjectCreation(initProject *projen.InitProject) {
