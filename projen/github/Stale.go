...
func (s *jsiiProxy_Stale) PostProjectCreation(initProject *projen.InitProject) {
...
func (s *jsiiProxy_Stale) ProjectCreation(initProject *projen.InitProject) {
...
func (s *jsiiProxy_Stale) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
