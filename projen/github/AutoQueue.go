...
func (a *jsiiProxy_AutoQueue) PostProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AutoQueue) ProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AutoQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
