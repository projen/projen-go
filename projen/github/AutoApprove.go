...
func (a *jsiiProxy_AutoApprove) ProjectCreation(initProject *projen.InitProject) {
...
func (a *jsiiProxy_AutoApprove) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
