...
func (m *jsiiProxy_MergeQueue) PostProjectCreation(initProject *projen.InitProject) {
...
func (m *jsiiProxy_MergeQueue) ProjectCreation(initProject *projen.InitProject) {
...
func (m *jsiiProxy_MergeQueue) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
