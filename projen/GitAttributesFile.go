...
func (g *jsiiProxy_GitAttributesFile) PostProjectCreation(initProject *InitProject) {
...
func (g *jsiiProxy_GitAttributesFile) ProjectCreation(initProject *InitProject) {
...
func (g *jsiiProxy_GitAttributesFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
