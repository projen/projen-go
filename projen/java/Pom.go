...
func (p *jsiiProxy_Pom) PostProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_Pom) ProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_Pom) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
