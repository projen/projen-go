...
func (p *jsiiProxy_Projenrc) PostProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_Projenrc) ProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_Projenrc) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
