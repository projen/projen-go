...
func (m *jsiiProxy_MavenPackaging) PostProjectCreation(initProject *projen.InitProject) {
...
func (m *jsiiProxy_MavenPackaging) ProjectCreation(initProject *projen.InitProject) {
...
func (m *jsiiProxy_MavenPackaging) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
