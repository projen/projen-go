...
func (m *jsiiProxy_MavenCompile) PostProjectCreation(initProject *projen.InitProject) {
...
func (m *jsiiProxy_MavenCompile) ProjectCreation(initProject *projen.InitProject) {
...
func (m *jsiiProxy_MavenCompile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
