...
func (j *jsiiProxy_Junit) PostProjectCreation(initProject *projen.InitProject) {
...
func (j *jsiiProxy_Junit) ProjectCreation(initProject *projen.InitProject) {
...
func (j *jsiiProxy_Junit) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
