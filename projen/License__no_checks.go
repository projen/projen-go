...
func (l *jsiiProxy_License) validatePostProjectCreationParameters(initProject *InitProject) error {
	return nil
}

func (l *jsiiProxy_License) validateProjectCreationParameters(initProject *InitProject) error {
	return nil
}
