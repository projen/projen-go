...
func (s *jsiiProxy_SourceCode) PostProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SourceCode) ProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SourceCode) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
