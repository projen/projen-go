...
func (s *jsiiProxy_SampleReadme) validatePostProjectCreationParameters(initProject *InitProject) error {
	return nil
}

func (s *jsiiProxy_SampleReadme) validateProjectCreationParameters(initProject *InitProject) error {
	return nil
}
