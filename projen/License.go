...
func (j *jsiiProxy_License) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (l *jsiiProxy_License) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (l *jsiiProxy_License) PostProjectCreation(initProject *InitProject) {
...
func (l *jsiiProxy_License) ProjectCreation(initProject *InitProject) {
...
func (l *jsiiProxy_License) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
