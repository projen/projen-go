...
func (y *jsiiProxy_YamlFile) validatePostProjectCreationParameters(initProject *InitProject) error {
	return nil
}

func (y *jsiiProxy_YamlFile) validateProjectCreationParameters(initProject *InitProject) error {
	return nil
}
