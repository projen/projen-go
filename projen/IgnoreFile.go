...
func (j *jsiiProxy_IgnoreFile) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (i *jsiiProxy_IgnoreFile) PostProjectCreation(initProject *InitProject) {
...
func (i *jsiiProxy_IgnoreFile) ProjectCreation(initProject *InitProject) {
...
func (i *jsiiProxy_IgnoreFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
