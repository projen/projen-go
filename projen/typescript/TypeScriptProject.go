...
func (j *jsiiProxy_TypeScriptProject) Runner() TypeScriptRunner {
...
func (t *jsiiProxy_TypeScriptProject) AddPackageIgnore(_pattern *string) {
...
func (t *jsiiProxy_TypeScriptProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
