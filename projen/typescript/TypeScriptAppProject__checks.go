...
func (t *jsiiProxy_TypeScriptAppProject) validateAddPackageIgnoreParameters(_pattern *string) error {
	if _pattern == nil {
...
func (t *jsiiProxy_TypeScriptAppProject) validateAnnotateGeneratedParameters(_glob *string) error {
	if _glob == nil {
