...
func (j *jsiiProxy_TypeScriptAppProject) Biome() javascript.Biome {
...
func (j *jsiiProxy_TypeScriptAppProject) Node() constructs.Node {
...
func (j *jsiiProxy_TypeScriptAppProject) Npmrc() javascript.NpmConfig {
...
func (j *jsiiProxy_TypeScriptAppProject) Subprojects() *[]projen.Project {
	var returns *[]projen.Project
	_jsii_.Get(
		j,
		"subprojects",
...
func (j *jsiiProxy_TypeScriptAppProject) WorkflowPackageCache() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
// Experimental.
func TypeScriptAppProject_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTypeScriptAppProject_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TypeScriptAppProject_IsProject(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTypeScriptAppProject_IsProjectParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TypeScriptAppProject_Of(construct constructs.IConstruct) projen.Project {
	_init_.Initialize()

	if err := validateTypeScriptAppProject_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns projen.Project
...
func TypeScriptAppProject_DEFAULT_TS_JEST_TRANFORM_PATTERN() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"projen.typescript.TypeScriptAppProject",
...
func (t *jsiiProxy_TypeScriptAppProject) AddPackageIgnore(_pattern *string) {
	if err := t.validateAddPackageIgnoreParameters(_pattern); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		t,
...
func (t *jsiiProxy_TypeScriptAppProject) AnnotateGenerated(_glob *string) {
...
func (t *jsiiProxy_TypeScriptAppProject) DefaultTypeScriptCompilerOptions() *javascript.TypeScriptCompilerOptions {
...
func (t *jsiiProxy_TypeScriptAppProject) ToString() *string {
	var returns *string
...
func (t *jsiiProxy_TypeScriptAppProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
