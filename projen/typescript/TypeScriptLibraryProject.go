...
func NewTypeScriptLibraryProject(options *TypeScriptProjectOptions) TypeScriptLibraryProject {
	...
	if err := validateNewTypeScriptLibraryProjectParameters(options); err != nil {
		panic(err)
	}
...
func TypeScriptLibraryProject_DEFAULT_TS_JEST_TRANFORM_PATTERN() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"projen.typescript.TypeScriptLibraryProject",
...
func (t *jsiiProxy_TypeScriptLibraryProject) AddPackageIgnore(_pattern *string) {
...
func (t *jsiiProxy_TypeScriptLibraryProject) AnnotateGenerated(_glob *string) {
