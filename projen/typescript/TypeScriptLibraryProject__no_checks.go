...
func (t *jsiiProxy_TypeScriptLibraryProject) validateAddPackageIgnoreParameters(_pattern *string) error {
	return nil
}
...
func (t *jsiiProxy_TypeScriptLibraryProject) validateAnnotateGeneratedParameters(_glob *string) error {
	return nil
}
...
func validateTypeScriptLibraryProject_IsConstructParameters(x interface{}) error {
	return nil
}

func validateTypeScriptLibraryProject_IsProjectParameters(x interface{}) error {
	return nil
}

func validateTypeScriptLibraryProject_OfParameters(construct constructs.IConstruct) error {
	return nil
}
