...
func (j *jsiiProxy_TomlFile) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (t *jsiiProxy_TomlFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (t *jsiiProxy_TomlFile) PostProjectCreation(initProject *InitProject) {
...
func (t *jsiiProxy_TomlFile) ProjectCreation(initProject *InitProject) {
...
func (t *jsiiProxy_TomlFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
