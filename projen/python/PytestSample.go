...
func (p *jsiiProxy_PytestSample) PostProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PytestSample) ProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PytestSample) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
