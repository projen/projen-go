...
func (p *jsiiProxy_PythonSample) PostProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PythonSample) ProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PythonSample) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
