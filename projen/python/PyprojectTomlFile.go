...
func (p *jsiiProxy_PyprojectTomlFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (p *jsiiProxy_PyprojectTomlFile) PostProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PyprojectTomlFile) ProjectCreation(initProject *projen.InitProject) {
...
func (p *jsiiProxy_PyprojectTomlFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
