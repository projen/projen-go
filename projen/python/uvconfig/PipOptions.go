...
type PipOptions struct {
	...
	// Experimental.
	AnnotationStyle AnnotationStyle `field:"optional" json:"annotationStyle" yaml:"annotationStyle"`
	...
	// Experimental.
	PythonPlatform TargetTriple `field:"optional" json:"pythonPlatform" yaml:"pythonPlatform"`
