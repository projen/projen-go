...
func (a *jsiiProxy_AiInstructionsFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (a *jsiiProxy_AiInstructionsFile) PostProjectCreation(initProject *InitProject) {
...
func (a *jsiiProxy_AiInstructionsFile) ProjectCreation(initProject *InitProject) {
...
func (a *jsiiProxy_AiInstructionsFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
