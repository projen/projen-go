...
func (s *jsiiProxy_SampleReadme) PostProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SampleReadme) ProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SampleReadme) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
