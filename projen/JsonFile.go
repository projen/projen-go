...
func (j *jsiiProxy_JsonFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (j *jsiiProxy_JsonFile) PostProjectCreation(initProject *InitProject) {
...
func (j *jsiiProxy_JsonFile) ProjectCreation(initProject *InitProject) {
...
func (j *jsiiProxy_JsonFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
