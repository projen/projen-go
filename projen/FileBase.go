...
func (j *jsiiProxy_FileBase) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (f *jsiiProxy_FileBase) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (f *jsiiProxy_FileBase) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
