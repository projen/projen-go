...
func (p *jsiiProxy_ProjectTree) PostProjectCreation(initProject *InitProject) {
...
func (p *jsiiProxy_ProjectTree) ProjectCreation(initProject *InitProject) {
...
func (p *jsiiProxy_ProjectTree) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
