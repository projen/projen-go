...
func (j *jsiiProxy_NextJsProject) Biome() javascript.Biome {
...
func (j *jsiiProxy_NextJsProject) WorkflowPackageCache() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func NewNextJsProject(options *NextJsProjectOptions) NextJsProject {
	...
	if err := validateNewNextJsProjectParameters(options); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NextJsProject) AddPackageIgnore(_pattern *string) {
...
func (n *jsiiProxy_NextJsProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
