...
func (j *jsiiProxy_ReactProject) Biome() javascript.Biome {
...
func (j *jsiiProxy_ReactProject) Node() constructs.Node {
...
func (j *jsiiProxy_ReactProject) NodeVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nodeVersion",
...
func (j *jsiiProxy_ReactProject) Npmrc() javascript.NpmConfig {
...
func (j *jsiiProxy_ReactProject) Subprojects() *[]projen.Project {
	var returns *[]projen.Project
	_jsii_.Get(
		j,
		"subprojects",
...
func (j *jsiiProxy_ReactProject) WorkflowBootstrapSteps() *[]*workflows.JobStep {
...
func NewReactProject(options *ReactProjectOptions) ReactProject {
	...
	if err := validateNewReactProjectParameters(options); err != nil {
		panic(err)
	}
...
// Experimental.
func ReactProject_IsConstruct(x interface{}) *bool {
	_init_.Initialize()

	if err := validateReactProject_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ReactProject_IsProject(x interface{}) *bool {
	_init_.Initialize()

	if err := validateReactProject_IsProjectParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func ReactProject_Of(construct constructs.IConstruct) projen.Project {
	_init_.Initialize()

	if err := validateReactProject_OfParameters(construct); err != nil {
		panic(err)
	}
	var returns projen.Project
...
func (r *jsiiProxy_ReactProject) AddScripts(scripts *map[string]*string) {
...
func (r *jsiiProxy_ReactProject) ToString() *string {
	var returns *string
...
func (r *jsiiProxy_ReactProject) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
