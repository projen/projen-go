...
func (r *jsiiProxy_ReactProject) validateAddPackageIgnoreParameters(_pattern *string) error {
	if _pattern == nil {
...
func (r *jsiiProxy_ReactProject) validateAnnotateGeneratedParameters(_glob *string) error {
	if _glob == nil {
...
func validateReactProject_IsConstructParameters(x interface{}) error {
	if x == nil {
...
func validateReactProject_IsProjectParameters(x interface{}) error {
	if x == nil {
		return fmt.Errorf("parameter x is required, but nil was provided")
	}
...
func validateReactProject_OfParameters(construct constructs.IConstruct) error {
	if construct == nil {
