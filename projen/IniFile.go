...
func (j *jsiiProxy_IniFile) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (i *jsiiProxy_IniFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (i *jsiiProxy_IniFile) PostProjectCreation(initProject *InitProject) {
...
func (i *jsiiProxy_IniFile) ProjectCreation(initProject *InitProject) {
...
func (i *jsiiProxy_IniFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
