...
func (j *jsiiProxy_TextFile) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (t *jsiiProxy_TextFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (t *jsiiProxy_TextFile) PostProjectCreation(initProject *InitProject) {
...
func (t *jsiiProxy_TextFile) ProjectCreation(initProject *InitProject) {
...
func (t *jsiiProxy_TextFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
