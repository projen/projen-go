...
func (a *jsiiProxy_AiInstructions) PostProjectCreation(initProject *InitProject) {
...
func (a *jsiiProxy_AiInstructions) ProjectCreation(initProject *InitProject) {
...
func (a *jsiiProxy_AiInstructions) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
