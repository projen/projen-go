...
func (p *jsiiProxy_ProjenrcFile) PostProjectCreation(initProject *InitProject) {
...
func (p *jsiiProxy_ProjenrcFile) ProjectCreation(initProject *InitProject) {
...
func (p *jsiiProxy_ProjenrcFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
