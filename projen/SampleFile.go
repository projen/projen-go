...
func (s *jsiiProxy_SampleFile) PostProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SampleFile) ProjectCreation(initProject *InitProject) {
...
func (s *jsiiProxy_SampleFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
