...
func (j *jsiiProxy_ObjectFile) Committed() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"committed",
...
func (o *jsiiProxy_ObjectFile) Diff(colorize *bool, contextLines *float64) *[]*string {
	var returns *[]*string
...
func (o *jsiiProxy_ObjectFile) PostProjectCreation(initProject *InitProject) {
	if err := o.validatePostProjectCreationParameters(initProject); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_ObjectFile) ProjectCreation(initProject *InitProject) {
	if err := o.validateProjectCreationParameters(initProject); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		o,
...
func (o *jsiiProxy_ObjectFile) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
