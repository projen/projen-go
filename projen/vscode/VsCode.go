...
func (v *jsiiProxy_VsCode) PostProjectCreation(initProject *projen.InitProject) {
...
func (v *jsiiProxy_VsCode) ProjectCreation(initProject *projen.InitProject) {
...
func (v *jsiiProxy_VsCode) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
